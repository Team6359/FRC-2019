...
public class SS_DriveTrain extends Subsystem {
	...
	public void Drive(double leftSpeed, double rightSpeed) {
		BL.set(ControlMode.PercentOutput, leftSpeed * leftSpeed * leftSpeed);
		BR.set(ControlMode.PercentOutput, rightSpeed * rightSpeed * rightSpeed);
		FL.set(ControlMode.PercentOutput, leftSpeed * leftSpeed * leftSpeed);
		FR.set(ControlMode.PercentOutput, rightSpeed * rightSpeed * rightSpeed);
